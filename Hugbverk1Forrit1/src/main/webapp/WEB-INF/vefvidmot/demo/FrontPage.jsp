...
<body>
	...
	<div
		...
		<div class="w3-display-middle">
			<h1 class="w3-jumbo w3-animate-top Fyrirsogn">LEARN ICELANDIC</h1>
			<hr class="w3-border-grey" style="margin: auto; width: 40%">
			<div class = "form">
			<form method="POST" action="FrontPage">
			<p class="w3-large w3-center">
				<button type="submit" name="button" value="button1" class="w3-button">Log in</button>
			</p>
			<p class="w3-large w3-center">
				<button type="submit" name="button" value="button2" class="w3-button">Sign up</button>
			</p>
			</form>
			</div>
		</div>
...
/* Háskóli Íslands 22. October 2017 modified by Arnór Kristmundsson */
html {
