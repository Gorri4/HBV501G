...
public class DemoController {
    ...
    @RequestMapping(value="/hver", method=RequestMethod.GET)
    ...
    public String krossar () {
    	return "demo/krossar";
    }
    
    @RequestMapping(value="/hvad", method=RequestMethod.POST)
    public String hvad (@RequestParam(value="answers", required=false)
    String answers, ModelMap model) {
    	model.addAttribute("answers", answers);
    	if (answers.equals("Hestur")) {
    		return "demo/krossarRett";
    	}
